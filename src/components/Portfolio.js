      ...
      <div className="container">
        <div className="roww">
          ...
          <div className="resumo_fn_main_title">
            ...
            <h3 className="title">Meine Arbeiten</h3>
          </div>
          {/* /Main Title */}
        </div>
      </div>
          ...
          >
            ...
            >
              <div className="img_holder">
                ...
                <div className="abs_img" data-bg-img="img/trust/wellness-hauptseite.webp" />
              </div>
              <div className="title_holder">
                <p>E-Commerce, SEO</p>
                <h3>
                  <a href="#">Arrigato GmbH</a>
                </h3>
              </div>
            ...
            >
              <div className="img_holder">
                <img src="img/thumb/square.jpg" alt="image" />
                <div className="abs_img" data-bg-img="img/trust/translationservice2.jpg" />
              </div>
              <div className="title_holder">
                <p>Web-Relaunch, SEO</p>
                <h3>
                  <a href="#">Localistars</a>
                </h3>
              </div>
              <div className="fn__hidden">
            ...
            >
              <div className="img_holder">
                <img src="img/thumb/square.jpg" alt="image" />
                <div className="abs_img" data-bg-img="img/trust/ont-ro.png" />
              </div>
              <div className="title_holder">
                <p>Web-Relaunch</p>
                <h3>
                  <a href="#">Ontronix AG</a>
                </h3>
              </div>
              <div className="fn__hidden">
            ...
            >
              ...
              <div className="title_holder">
                <p>Google Shopping, SEO</p>
                <h3>
                  <a href="#">Swissqrreader</a>
                </h3>
              </div>
              <div className="fn__hidden">
                <p className="fn__cat">mobile, design</p>
